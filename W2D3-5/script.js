...
const superHeroWeight190 = superHeroes.filter ((item) => { 
    if  ( item.weight < 190 ) {
    return item.name
    } 
    }); 

console.log(superHeroWeight190); 


const superHeroWeight200 = superHeroes.filter ((item) => { 
    if  ( item.weight == 200 ) {
    return item.name
    } 
    }); 
...
const apperance = superHeroes.map ((item) => { 
...
// const total = superHeroes.reduce ((currentTotal, item) => { 
